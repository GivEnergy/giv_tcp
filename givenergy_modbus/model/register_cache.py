...
from givenergy_modbus.model.register import HoldingRegister, HoldingRegister_AC, InputRegister, Register  # type: ignore  # shut up mypy

class RegisterCache_AC(dict):
    ...
    def __init__(self, registers=None) -> None:
        ...
        for k, v in HoldingRegister_AC.__members__.items():
            self._register_lookup_table[k] = v
    ...
    @classmethod
    def from_json(cls, data: str) -> RegisterCache_AC:
        """Instantiate a RegisterCache_AC from its JSON form."""
